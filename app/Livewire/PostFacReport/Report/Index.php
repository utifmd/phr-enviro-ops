...
namespace App\Livewire\PostFacReport\Report;
...
class Index extends Component
{
    ...
    private function getPostDetailYHeaderBy(string $date): array
    {
        ...
        /*$builder->whereHas('postsFacReport', function ($query) {
    ...
    {
        return PostFacReport::query()->where('date', $date);
    }
    ...
    {
        return view('livewire.post-fac-report.report.index');
    }
}
