...
class Show extends Component
{
        ...
        Post $post, IWorkTripRepository $wtRepos, IUtility $util): void
    {
        ...
        $this->initWorkTrips($post->postsFacReport);
    }
    ...
    public function onChangeStatus(string|array $idOrIds, string $request): void
    {
        ...
        try {
            ...
            $isClosed = $request != PostFacReportStatusEnum::APPROVED->value
    ...
    public function onAllowAllRequestPressed(): void
    {
        $this->onChangeStatus(
            $this->tripIdsQueue,
            PostFacReportStatusEnum::APPROVED->value
        );
    }
    /**
     * @throws AuthorizationException
    ...
    public function onDeniedAllRequestPressed(): void
    {
        $this->onChangeStatus(
            $this->tripIdsQueue,
            PostFacReportStatusEnum::REJECTED->value
        );
    }
    ...
    {
        return view('livewire.post-fac-report.request.show');
    }
}
