...
class Create extends Component
{
    ...
    public function mount(PostWoPlanOrder $order): void
    {
        ...
        $workTrip = new PostFacReport();
        $workTrip->type = PostFacReportTypeEnum::PLAN->value;
    ...
    public function addOrderThenNextToTripPlan(): void
    {
        ...
        $userCurrentPost = [
            'steps' => '0;1;2;3',
            'step_at' => PostWoPlanTrip::ROUTE_POS,
            'url' => PostWoPlanTrip::ROUTE_NAME . '.confirm'
        ];
    ...
    public function render(): View
    {
        ...
        return view(
            'livewire.'.PostWoPlanOrder::ROUTE_NAME. $case
        );
    }
}
