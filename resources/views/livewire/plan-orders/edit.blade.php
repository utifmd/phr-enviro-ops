...
<div class="flex flex-col md:flex-row p-12 space-x-6 space-y-6">
    <div class="w-full md:w-3/12 sm:p-6 lg:p-8">
        @include('livewire.workorders.components.left-pane', [
            'steps' => $steps, 'stepAt' => \App\Models\PlanOrder::ROUTE_POS // $stepAt
        ])
    </div>
                ...
                <div class="w-full">
                    ...
                    <div class="sm:flex sm:items-center">
                        <div class="sm:flex-auto">
                            <h1 class="text-base font-semibold leading-6 text-gray-900">{{ __('Edit') }} Orders Plan</h1>
                            <p class="mt-2 text-sm text-gray-700">{{ __('Edit Planning Estimation Order') }}.</p>
                        </div>
                    ...
                    <div class="flow-root">
                        <div class="mt-8 overflow-x-auto">
                            <div class="inline-block min-w-full py-2 align-middle">
                                <form method="POST" wire:submit="changePlanOrder" role="form"
