            ...
            <div class="w-full">
                <div class="sm:flex sm:items-center">
                    ...
                    <div class="flex space-x-1 mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                        ...
                        <a href="{{ route('post-fac-out.create') }}" class="flex hover:opacity-85" wire:navigate>
                                    ...
                                    <tr class="even:bg-gray-50" wire:key="{{ $workTripDetail->id }}">
                                        ...
                                        @can(\App\Policies\UserPolicy::IS_USER_IS_VT_CREW)
                                            <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900">
                                                <a wire:navigate href="{{ route('post-fac-in.show', $workTripDetail->id) }}" class="text-gray-600 font-bold hover:text-gray-900 mr-2">{{ __('Show') }}</a>
                                                <a wire:navigate href="{{ route('post-fac-in.edit', $workTripDetail->id) }}" class="text-indigo-600 font-bold hover:text-indigo-900  mr-2">{{ __('Edit') }}</a>
                                                <button
