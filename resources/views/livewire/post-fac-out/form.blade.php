...
<div x-data="{
 formState:{
    ...
    <div>
        ...
        <x-select-option wire:model="form.from_facility" :cases="$facilities" id="from_facility" name="from_facility"
    ...
    <div>
        ...
        <x-select-option wire:model="form.from_pit" :cases="$pits" id="from_pit" name="from_pit" type="text"
    ...
    <div>
        ...
        <x-select-option wire:model="form.to_facility" :cases="$facilities" id="to_facility" name="to_facility"
                         type="text" class="mt-1 block w-full"
    ...
    <div>
        ...
        <div id="type" class="flex flex-wrap ms-2 space-x-6">
            <div class="flex items-center">
                ...
                <label for="red-radio"
                       class="ms-2 text-sm font-medium text-gray-900 darktext-gray-300">{{$treatedWater}}</label>
            </div>
            <div class="flex items-center">
                ...
                <label for="green-radio"
                       class="ms-2 text-sm font-medium text-gray-900 darktext-gray-300">{{$concentratedWater}}</label>
            </div>
        </div>
        @error('form.type')
        <x-input-error class="mt-2" :messages="$message"/>
