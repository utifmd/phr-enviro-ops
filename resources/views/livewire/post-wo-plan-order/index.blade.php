                ...
                <div class="sm:flex sm:items-center">
                    ...
                    <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                        <a type="button" wire:navigate
                           href="{{ route(\App\Models\PostWoPlanOrder::ROUTE_NAME.'.create') }}"
                                ...
                                @foreach ($orders as $order)
                                    <tr class="even:bg-gray-50" wire:key="{{ $order->id }}">
                                        ...
                                        <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900">
                                            <a wire:navigate
                                               href="{{ route(\App\Models\PostWoPlanOrder::ROUTE_NAME.'.show', $order->id) }}"
                                               class="text-gray-600 font-bold hover:text-gray-900 mr-2">{{ __('Show') }}</a>
                                            <a wire:navigate
                                               href="{{ route(\App\Models\PostWoPlanOrder::ROUTE_NAME.'.edit', $order->id) }}"
