...
<div class="flex flex-col md:flex-row p-12 space-x-6 space-y-6">
    <div class="w-full md:w-3/12 sm:p-6 lg:p-8">
        @include('livewire.post-wo.components.left-pane', [
            'steps' => $steps, 'stepAt' => \App\Models\PostWoInfo::ROUTE_POS // $stepAt
        ])
    </div>
                ...
                <div class="w-full">
                    ...
                    <div class="sm:flex sm:items-center">
                        <div class="sm:flex-auto">
                            <h1 class="text-base font-semibold leading-6 text-gray-900">{{ __('Edit') }} PostWoInfo</h1>
                            <p class="mt-2 text-sm text-gray-700">Edit current {{ __('PostWoInfo') }}.</p>
                        </div>
                    ...
                    <div class="flow-root">
                        <div class="mt-8 overflow-x-auto">
                            <div class="max-w-xl py-2 align-middle">
                                <form method="POST" wire:submit="changeInformation" role="form"
                                      enctype="multipart/form-data">
                                    {{ method_field('PATCH') }}
                                    @csrf
                                    @include('livewire.post-wo-info.form')
                                </form>
                            </div>
                        </div>
                    </div>
