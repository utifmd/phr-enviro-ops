...
<div class="space-y-6">
    ...
    <div>
        ...
        <x-text-input
                wire:model="form.vehicle_type" disabled="true" id="vehicle_type" name="vehicle_type" type="text"
                class="mt-1 block w-full" placeholder="Vehicle Type"/>
    ...
    <div>
        ...
        <div id="shift" class="flex flex-wrap ms-2 space-x-6">
            ...
            <div class="flex items-center">
                <input wire:model="form.shift" id="shift" name="shift" type="radio"
                       value="{{\App\Utils\PostWoInfoShiftEnum::NIGHT->value}}"
                       class="w-4 h-4 text-green-600 bg-gray-100 border-gray-300 focusring-green-500 dark:focusring-green-600 dark:ring-offset-gray-800 focusring-2 dark:bg-gray-700 dark:border-gray-600">
                <label for="green-radio"
                       class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">{{\App\Utils\PostWoInfoShiftEnum::NIGHT->value}}</label>
            </div>
        </div>
        @error('form.shift')
        <x-input-error class="mt-2" messages="message"/>
