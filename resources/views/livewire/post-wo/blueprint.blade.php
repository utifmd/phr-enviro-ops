                ...
                <div class="w-full">
                    ...
                    <div class="sm:flex sm:items-center">
                        <div class="sm:flex-auto">
                            <h1 class="text-base font-semibold leading-6 text-gray-900">{{ __('Print') }} Work
                                Order</h1>
                        ...
                        <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                            ...
                            <x-general-button :disabled="$disabled" wire:loading.attr="disabled" wire:click="finish"
                                              wire:confirm="Are you sure you want to finish workorder?">Finish
                            </x-general-button>
                            {{--<div>
