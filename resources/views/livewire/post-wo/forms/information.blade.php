...
new class extends Component {
    ...
    public ?PostWoInfo $storedInformation = null;*/
    public int $numberValue;

    public function mount(PostWoInfo $information): void
    {
        /*$this->storedInformation = $this->storedInformation
            ?? PostWoInfo::query()->where('post_id', '=', 1)->get()->first();*/
...
<section>
    <header>
        <h2 class="text-lg font-medium text-gray-900">
            {{ __('PostWoInfo') }} <span wire:click="resetStoredInformation">edit</span>
        </h2>
    ...
    <form method="POST" wire:submit="addInformation" class="mt-6 space-y-6" role="form" enctype="multipart/form-data">
        ...
        <div class="flex items-center gap-4">
            ...
            <x-action-message class="me-3" on="add-information">
                {{ __('PostWoInfo added successfully.') }}
            </x-action-message>
        </div>
    </form>
</section>
