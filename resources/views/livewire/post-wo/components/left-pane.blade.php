<ol class="relative text-gray-500 border-s border-gray-200 dark:border-gray-700 dark:text-gray-400">
    ...
    <li class="mb-10 ms-6">
        ...
        @endif
        <a class="{{in_array(1, $steps) ? '' : 'pointer-events-none'}}"
           href="{{ route(\App\Models\PostWoInfo::ROUTE_NAME.'.create')}}" wire:navigate.hover>
            <h3 class="{{$stepAt == 1 ? 'text-green-600 font-bold' : 'font-medium'}} leading-tight">PostWoInfo</h3>
        </a>
    ...
    <li class="mb-10 ms-6">
        ...
        @endif
        <a class="{{in_array(2, $steps) ? '' : 'pointer-events-none'}}"
           href="{{ route(\App\Models\PostWoPlanOrder::ROUTE_NAME.'.create')}}" wire:navigate.hover>
    ...
    <li class="mb-10 ms-6">
        ...
        @endif
        <a class="{{in_array(3, $steps) ? '' : 'pointer-events-none'}}"
           href="{{ route(\App\Models\PostWoPlanTrip::ROUTE_NAME.'.confirm')}}" wire:navigate.hover>
    ...
    <li class="ms-6">
        ...
        @endif
        <a class="{{in_array(4, $steps) ? '' : 'pointer-events-none'}}"
           href="{{ route(\App\Models\PostWo::ROUTE_NAME.'.blueprint', $postId ?? '')}}" wire:navigate.hover>
